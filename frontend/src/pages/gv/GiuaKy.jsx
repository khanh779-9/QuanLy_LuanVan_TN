          ...
          <div className="max-h-[70vh] overflow-y-auto pr-0">
            ...
            <div className="mb-2">
              ...
              <div className="grid grid-cols-1 gap-2 md:grid-cols-2">
                <div>
                  <label className="mb-1 block text-xs font-medium text-slate-700">Điểm giữa kỳ (0-10)</label>
                  <input
                    type="number"
                    min="0"
                    max="10"
                ...
                <div>
                  <label className="mb-1 block text-xs font-medium text-slate-700">Trạng thái dự kiến</label>
                  <div className="flex min-h-[30px] items-center rounded border border-slate-200 bg-slate-50 px-3 py-1">
                    {trangThaiGiuaKy ? (
                      <span className={`rounded-full px-3 py-1 text-xs font-semibold ${trangThaiGiuaKy === 'dat' ? 'bg-green-100 text-green-700' : 'bg-red-100 text-red-600'}`}>
